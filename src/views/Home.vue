...
<!--                        <span @click="$router.push({path:item.path})">{{item.authName}}</span>-->
        ...
        <el-backtop class="kefu" :bottom="50" :right="285">
            ...
            >
                <img class="kefuImg" v-show="isShow" src="../assets/img/gongzhonghaozhanshi.png">
                <el-button @click="kefuClick" @mouseenter.native="kefuShow" @mouseleave.native="kefuHide" slot="reference" style="background: none;border:none;padding: 0;">
